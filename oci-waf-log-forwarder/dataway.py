...
from datakit import BaseDataKit, PY3, text_type, binary_type, ensure_binary
...
class DataWay(BaseDataKit):
    def __init__(self, *args, token=None, access_key=None, secret_key=None,
                 min_gzip_bytes=DEFAULT_MIN_GZIP_BYTES,
                 gzip_compresslevel=1, **kwargs):
        super().__init__(
            *args,
        ...
        self.storage_index_in_header = True
    ...
    def _prepare_request_auth(self, method, content_type=None, body=None):
        return self._prepare_auth_headers(
            method=method,
